...
import (
	...
	"github.com/frankli-dev/chainbridge-utils/crypto"
	"github.com/frankli-dev/chainbridge-utils/crypto/secp256k1"
	"github.com/frankli-dev/chainbridge-utils/crypto/sr25519"
...
func handleGenerateCmd(ctx *cli.Context, dHandler *dataHandler) error {
	...
	_, err := generateKeypair(keytype, dHandler.datadir, password, 42)
	if err != nil {
